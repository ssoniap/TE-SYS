...
const Footer = () =>{
    return(
        ...
        <p className="text-center text-muted"><NavLink to="/" className="nav-lin text-muted" activeClassName="text-withe" exact><img className="imagen justify-content-center" src={logo} alt="" width="90" height="40"></img></NavLink></p>
